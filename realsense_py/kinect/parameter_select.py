...
def vis_mask(dirPath):
    ...
    color_list = os.listdir(os.path.join(sub_dir_list[dir_idx], 'color'))
    color_list.sort()

    depth_list = os.listdir(os.path.join(sub_dir_list[dir_idx], 'depth'))
    depth_list.sort()
    colorfilelist = [os.path.join(sub_dir_list[dir_idx],'color',imagename) for i, imagename in enumerate(color_list)]
    depthfilelist = [os.path.join(sub_dir_list[dir_idx],'depth',imagename) for i, imagename in enumerate(depth_list)]
    ...
    colorfilename = colorfilelist[0]
    depthfilename = colorfilelist[0]
    imgs = read_rgbd_and_draw(sub_dir_list[dir_idx], colorfilelist[0], depthfilelist[0])
    ...
    while True:
        ...
        if pressedKey == ord('a'):
            ...
            depth_list = os.listdir(os.path.join(sub_dir_list[dir_idx], 'depth'))
            depth_list.sort()
            colorfilename = [os.path.join(sub_dir_list[dir_idx],'color',imagename) for i, imagename in enumerate(color_list)][frame_idx]
            depthfilename = [os.path.join(sub_dir_list[dir_idx],'depth',imagename) for i, imagename in enumerate(depth_list)][frame_idx]
...
if __name__ == '__main__':
    ...
    save_path = '/Users/lizhe/Data/TMM2022/plot/longterm/plotdata/'
    ...
    # depthQ_path = '/Users/lizhe/Data/TMM2022/plot/depthQ/origindata/'
    depthQ_path = '/Users/lizhe/Data/TMM2022/plot/longterm/plotdata'
